...
class fg:
    ...
    aliceblue: str = field(default="\033[38;2;240;248;255m")
    antiquewhite: str = field(default="\033[38;2;250;235;215m")
    aqua: str = field(default="\033[38;2;0;255;255m")
    aquamarine: str = field(default="\033[38;2;127;255;212m")
    azure: str = field(default="\033[38;2;240;255;255m")
    beige: str = field(default="\033[38;2;245;245;220m")
    bisque: str = field(default="\033[38;2;255;228;196m")
    black: str = field(default="\033[38;2;0;0;0m")
    blanchedalmond: str = field(default="\033[38;2;255;235;205m")
    blue: str = field(default="\033[34m")
    blueviolet: str = field(default="\033[38;2;138;43;226m")
    brown: str = field(default="\033[38;2;165;42;42m")
    burlywood: str = field(default="\033[38;2;222;184;135m")
    cadetblue: str = field(default="\033[38;2;95;158;160m")
    chartreuse: str = field(default="\033[38;2;127;255;0m")
    chocolate: str = field(default="\033[38;2;210;105;30m")
    coral: str = field(default="\033[38;2;255;127;80m")
    cornflowerblue: str = field(default="\033[38;2;100;149;237m")
    cornsilk: str = field(default="\033[38;2;255;248;220m")
    crimson: str = field(default="\033[38;2;220;20;60m")
    cyan: str = field(default="\033[36m")
    darkblue: str = field(default="\033[38;2;0;0;139m")
    darkcyan: str = field(default="\033[38;2;0;139;139m")
    darkgoldenrod: str = field(default="\033[38;2;184;134;11m")
    darkgray: str = field(default="\033[38;2;169;169;169m")
    darkgreen: str = field(default="\033[38;2;0;100;0m")
    darkkhaki: str = field(default="\033[38;2;189;183;107m")
    darkmagenta: str = field(default="\033[38;2;139;0;139m")
    darkolivegreen: str = field(default="\033[38;2;85;107;47m")
    darkorange: str = field(default="\033[38;2;255;140;0m")
    darkorchid: str = field(default="\033[38;2;153;50;204m")
    darkred: str = field(default="\033[38;2;139;0;0m")
    darksalmon: str = field(default="\033[38;2;233;150;122m")
    darkseagreen: str = field(default="\033[38;2;143;188;143m")
    darkslateblue: str = field(default="\033[38;2;72;61;139m")
    darkslategray: str = field(default="\033[38;2;47;79;79m")
    darkturquoise: str = field(default="\033[38;2;0;206;209m")
    darkviolet: str = field(default="\033[38;2;148;0;211m")
    deeppink: str = field(default="\033[38;2;255;20;147m")
    deepskyblue: str = field(default="\033[38;2;0;191;255m")
    dimgray: str = field(default="\033[38;2;105;105;105m")
    dodgerblue: str = field(default="\033[38;2;30;144;255m")
    firebrick: str = field(default="\033[38;2;178;34;34m")
    floralwhite: str = field(default="\033[38;2;255;250;240m")
    forestgreen: str = field(default="\033[38;2;34;139;34m")
    fuchsia: str = field(default="\033[38;2;255;0;255m")
    gainsboro: str = field(default="\033[38;2;220;220;220m")
    ghostwhite: str = field(default="\033[38;2;248;248;255m")
    gold: str = field(default="\033[38;2;255;215;0m")
    goldenrod: str = field(default="\033[38;2;218;165;32m")
    gray: str = field(default="\033[97m")
    green: str = field(default="\033[32m")
    greenyellow: str = field(default="\033[38;2;173;255;47m")
    honeydew: str = field(default="\033[38;2;240;255;240m")
    hotpink: str = field(default="\033[38;2;255;105;180m")
    indianred: str = field(default="\033[38;2;205;92;92m")
    indigo: str = field(default="\033[38;2;75;0;130m")
    ivory: str = field(default="\033[38;2;255;255;240m")
    khaki: str = field(default="\033[38;2;240;230;140m")
    lavender: str = field(default="\033[38;2;230;230;250m")
    lavenderblush: str = field(default="\033[38;2;255;240;245m")
    lawngreen: str = field(default="\033[38;2;124;252;0m")
    lemonchiffon: str = field(default="\033[38;2;255;250;205m")
    lightblue: str = field(default="\033[38;2;173;216;230m")
    lightcoral: str = field(default="\033[38;2;240;128;128m")
    lightcyan: str = field(default="\033[38;2;224;255;255m")
    lightgoldenrodyellow: str = field(default="\033[38;2;250;250;210m")
    lightgray: str = field(default="\033[38;2;211;211;211m")
    lightgreen: str = field(default="\033[38;2;144;238;144m")
    lightpink: str = field(default="\033[38;2;255;182;193m")
    lightsalmon: str = field(default="\033[38;2;255;160;122m")
    lightseagreen: str = field(default="\033[38;2;32;178;170m")
    lightskyblue: str = field(default="\033[38;2;135;206;250m")
    lightyellow: str = field(default="\033[38;2;255;255;224m")
    lime: str = field(default="\033[38;2;0;255;0m")
    linen: str = field(default="\033[38;2;250;240;230m")
    magenta: str = field(default="\033[35m")
    maroon: str = field(default="\033[38;2;128;0;0m")
    mediumaquamarine: str = field(default="\033[38;2;102;205;170m")
    mediumorchid: str = field(default="\033[38;2;186;85;211m")
    mediumseagreen: str = field(default="\033[38;2;60;179;113m")
    mediumslateblue: str = field(default="\033[38;2;123;104;238m")
    mediumspringgreen: str = field(default="\033[38;2;0;250;154m")
    mediumvioletred: str = field(default="\033[38;2;199;21;133m")
    mintcrea: str = field(default="\033[38;2;245;255;250m")
    mistyrose: str = field(default="\033[38;2;255;228;225m")
    navajowhite: str = field(default="\033[38;2;255;222;173m")
    oldlace: str = field(default="\033[38;2;253;245;230m")
    olive: str = field(default="\033[38;2;128;128;0m")
    orange: str = field(default="\033[38;2;255;165;0m")
    orangered: str = field(default="\033[38;2;255;69;0m")
    palegoldenrod: str = field(default="\033[38;2;238;232;170m")
    palegreen: str = field(default="\033[38;2;152;251;152m")
    palevioletred: str = field(default="\033[38;2;219;112;147m")
    peru: str = field(default="\033[38;2;205;133;63m")
    plu: str = field(default="\033[38;2;221;160;221m")
    powderblue: str = field(default="\033[38;2;176;224;230m")
    purple: str = field(default="\033[38;2;128;0;128m")
    red: str = field(default="\033[31m")
    rosybrown: str = field(default="\033[38;2;188;143;143m")
    saddlebrown: str = field(default="\033[38;2;139;69;19m")
    salmon: str = field(default="\033[38;2;250;128;114m")
    sandybrown: str = field(default="\033[38;2;244;164;96m")
    seashell: str = field(default="\033[38;2;255;245;238m")
    silver: str = field(default="\033[38;2;192;192;192m")
    skyblue: str = field(default="\\033[033m[\033[38;2;135;206;235mm")
    slateblue: str = field(default="\033[38;2;106;90;205m")
    snow: str = field(default="\033[38;2;255;250;250m")
    steelblue: str = field(default="\033[38;2;70;130;180m")
    tan: str = field(default="\033[38;2;210;180;140m")
    teal: str = field(default="\033[38;2;0;128;128m")
    thistle: str = field(default="\033[38;2;216;191;216m")
    wheat: str = field(default="\033[38;2;245;222;179m")
    white: str = field(default="\033[77m")
    yellow: str = field(default="\033[33m")
    yellowgreen: str = field(default="\033[38;2;154;205;50m")
    ...
    def all() -> list[str]:
        ...
        for k, v in fg().__dict__.items():
            print(f"{v}{k}", end=f"{style.reset}\t")
            print()
        return list(fg().__dict__.values())
